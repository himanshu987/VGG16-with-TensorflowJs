...
// to read the file and initialise the reader object and to display the file on the image tag or html basically to manupulate the dom
...
async function loadModel(name){
    model=await tf.loadModel(`http://localhost:8001/${name}/model.json`); // model.json is basically a index the appl. will refer to understand how the model is designed and where and which file to take in when we need to implement the particular function
// model.json will basically direct the appl. what and which file when to use
    $('.progress-bar').hide();
}
